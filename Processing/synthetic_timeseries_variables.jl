...
synthetic_results_path = joinpath(results_path,"$(scenario)_$(market_design)_$(variable)_$year_nr.csv")

out_path      = joinpath(results_path,"synthetic_$(scenario)_$(market_design)_$(variable)_$(year_nr).csv")
...
# vermenigvuldig met 10^6 zodat je van 10^6€ naar €
year_hours_8760 .*= 1e6
...
out_df = DataFrame(timestamp = timestamps, electricity_price = year_hours_8760)
...
# ==== PDC MAKEN ====
prices = collect(df.electricity_price)                 # Vector van 8760 prijzen
